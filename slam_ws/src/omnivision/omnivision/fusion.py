...
class Fusion(Node):
    def __init__(self):
        ...
        self.declare_parameter('pointcloud_topic', '/livox/points')
    ...
    def process_data(self):
        ...
        points = pc2.read_points(self.latest_pointcloud, field_names=("x", "y", "z", "intensity", "line", "t"), skip_nans=True)
        points = list(points)
        ...
        x = x[valid_indices]
        y = y[valid_indices]
        z = z[valid_indices] # filter to no. of valid points
